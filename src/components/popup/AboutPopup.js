        ...
        <div className="left">
          <div className="left_inner">
            ...
            <div className="edrea_tm_button full">
              <a href="/document/M Muzamal Khan Software Engineer.pdf" download>
                Download CV
              </a>
            </div>
          </div>
        ...
        <div className="right">
          <div className="right_inner">
            <div className="biography">
              ...
              <div className="text">
                <p>
                  Hello everybody! My name is <span>Rana Muzamil.</span> I am a
                  Software Engineer, and {`I'm`} very with a passion for
                  creating innovative and user-friendly web solutions. I
                  specialize in creating dynamic and user-friendly web
                  applications using a combination of HTML, CSS, JavaScript,
                  ReactJS, React-Redux, NextJS and expanding my knowledge by
            ...
            <div className="testimonial" style={{ marginBottom: "20px" }}>
              <div className="about_title">
                <h3>
                  <span>
                    My <span className="coloring">Team</span>
                  </span>
                </h3>
              </div>
              <div className="list">
                <Swiper {...testimonialSlider} className="owl-carousel">
                  <SwiperSlide>
                    <div className="list_inner">
                      <div className="text">
                        <p>
                          Driven and enthusiastic software engineer who
                          constantly strives to deliver cutting-edge and
                          inventive solutions
                        </p>
                      </div>
                      <div className="details">
                        ...
                        <div className="info">
                          <h3>M Asad</h3>
                          <span>Software Engineer | PHP Laraval | MERN</span>
                        </div>
                      </div>
                    </div>
                  </SwiperSlide>
